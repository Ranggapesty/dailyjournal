...
<!-- article end -->
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4 justify-content-center">
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Rekayasa Perangkat Lunak<br />07.00-09.30 | H.3.11</li>
                <li class="list-group-item">Pendidikan Kewarganegaraan<br />14.10-15.50 | Kulino</li>
              </ul>
            </div>
          </div>
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Logika Informatika<br />07.00-09.30 | H.4.6</li>
                <li class="list-group-item">Tecnoprenuership<br />12:30-14:10 | Kulino</li>
              </ul>
            </div>
          </div>
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Probabilitas dan Statistik<br />07:00-09:30 | H.4.4</li>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Basis Data<br />07:00-08:40 | H.5.2</li>
              </ul>
            </div>
          </div>
          <div class="col">
            <div class="card h-100">
              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item">Bahasa Inggris<br />07:00-08:40 | Kulino</li>
                <li class="list-group-item">Basis Data<br />10:20-12:00 | D.2.K</li>
                <li class="list-group-item">Sistem Operasi<br />12:30-15:00 | H.5.3</li>
              </ul>
            </div>
          </div>
          <div class="col">
    ...
    <footer id="footer" class="text-center p-5">
      <div>
        <a href="https://www.instagram.com/rnggacly._/"><i class="bi bi-instagram h2 p-2"></i></a>
        <a href="https://twitter.com/udinusofficial"><i class="bi bi-twitter h2 p-2"></i></a>
        <a href="https://wa.me/6282137656626"><i class="bi bi-whatsapp h2 p-2"></i></a>
      </div>
      <div>Ranggapesty Ajisaputra &copy; 2024</div>
    </footer>
    <!-- footer end -->
